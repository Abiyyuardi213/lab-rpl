...
@section('content')
    <div class="bg-white min-h-screen">
        {{-- Hero Section --}}
        <section class="max-w-screen-2xl mx-auto px-6 md:px-10 pt-10 md:pt-16 pb-20 overflow-hidden">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="flex flex-col gap-6 relative z-10">
                    ...
                    <h1
                        ...
                        Daftar <br>
                        <span class="text-[#1a4fa0]">Praktikum & Pelatihan</span>
                    </h1>
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <img src="{{ asset('image/praktikum1.jpg') }}" alt="Kegiatan Praktikum"
                            class="w-full h-full object-cover transition duration-700 group-hover:scale-110">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                        <div class="absolute bottom-6 left-6 text-white text-left">
                            <h3 class="font-bold text-xl">Hands-on Experience</h3>
                            <p class="text-white/80 text-sm">Belajar dengan Implementasi Proyek Riil</p>
                        </div>
                    </div>
                </div>
            </div>
