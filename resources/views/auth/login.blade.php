...
<head>
    ...
    <title>Login Admin - LabRPL AdminPanel</title>
    <!-- Google Fonts: Inter -->
        ...
        <div class="main-card">
            ...
            <div class="right-panel">
                <div class="mb-6">
                    ...
                    <h1 class="text-2xl font-bold text-slate-900 mb-1">Login Admin</h1>
                    <p class="text-slate-500 text-xs leading-relaxed">Sistem Informasi Laboratorium Rekayasa Perangkat Lunak - ITATS</p>
                </div>

                <form action="{{ route('login.post') }}" method="POST" class="flex-grow">
                    @csrf

                    <label for="username" class="form-label">Username</label>
                    <div class="input-wrapper">
                        <span class="input-icon"><i class="fas fa-user"></i></span>
                        <input type="text" name="username" id="username" value="{{ old('username') }}" class="input-field" placeholder="Masukkan username anda" required autofocus>
                    </div>
                    @error('username')
                    ...
                    <div class="mt-4 p-3 bg-slate-50 rounded-xl border border-slate-100 flex items-start gap-3">
                        ...
                        <p class="text-[10px] text-slate-500 font-medium leading-relaxed italic">
                            Gunakan username yang telah terdaftar oleh Administrator Lab.
                        </p>
                    </div>
                </form>
