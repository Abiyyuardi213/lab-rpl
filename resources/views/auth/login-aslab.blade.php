...
<head>
    ...
    <title>Login Aslab - LabRPL AdminPanel</title>
    <!-- Font Inter -->
    ...
    <div class="w-full max-w-md bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden">
        <div class="p-8">
            <div class="flex items-center justify-center gap-3 mb-8">
                ...
                <h2 class="text-lg font-bold text-zinc-900 tracking-tight text-center">Login Aslab</h2>
            </div>

            <form action="{{ route('login.aslab.post') }}" method="POST" class="space-y-5">
                @csrf
        ...
        <div class="px-8 py-5 bg-zinc-50 border-t border-zinc-100 space-y-4">
            <div class="flex items-center gap-3">
                ...
                <p class="text-xs text-zinc-500 font-medium leading-tight italic">Pastikan NPM yang Anda masukkan sudah
                    terdaftar sebagai Asisten Laboratorium oleh Admin Utama.</p>
            </div>

            <div class="h-[1px] bg-zinc-200/50 w-full"></div>

            <div class="text-center">
                <p class="text-[10px] font-black text-zinc-400 uppercase tracking-widest mb-3">Bukan asisten
                    laboratorium?</p>
                <a href="{{ route('login') }}"
                    ...
                    <span>Login Sebagai Admin/User</span>
