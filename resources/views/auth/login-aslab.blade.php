        ...
        <div class="main-card">
            ...
            <div class="right-panel">
                <div class="mb-6">
                    ...
                    <h1 class="text-2xl font-bold text-slate-900 mb-1">Login Aslab</h1>
                    <p class="text-slate-500 text-xs leading-relaxed">Sistem Informasi Laboratorium Rekayasa Perangkat Lunak - ITATS</p>
                </div>

                <form action="{{ route('login.aslab.post') }}" method="POST" class="flex-grow">
                    @csrf
                    ...
                    <div class="mt-4 p-3 bg-slate-50 rounded-xl border border-slate-100 flex items-start gap-3">
                        ...
                        <p class="text-[10px] text-slate-500 font-medium leading-relaxed italic">
                            Pastikan NPM yang Anda masukkan sudah terdaftar sebagai Asisten Laboratorium oleh Admin Utama.
                        </p>
                    </div>
                </form>
