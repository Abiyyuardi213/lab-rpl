    ...
    <div class="relative bg-white font-sans overflow-hidden">
        ...
        <nav class="relative z-10 max-w-screen-xl mx-auto px-6 pt-12 pb-8">
            <ol class="flex items-center space-x-2 text-sm text-slate-500 font-medium">
                ...
                <li class="flex items-center space-x-2">
                    ...
                    <a href="{{ route('kegiatan.public') }}" class="hover:text-blue-600 transition-colors">Kegiatan</a>
                </li>
                <li class="flex items-center space-x-2">
                    <svg class="h-5 w-5 text-slate-300" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                    ...
                    <span class="text-slate-900 truncate max-w-[200px] sm:max-w-xs">{{ $kegiatan->judul }}</span>
                </li>
            </ol>
        </nav>
        ...
        <header class="relative z-10 max-w-screen-xl mx-auto px-6 pb-12">
            <div class="max-w-4xl">
                @if ($kegiatan->lokasi)
                    <div
                        class="inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ring-1 ring-inset mb-6 bg-blue-50 text-blue-700 ring-blue-700/10">
                        <i class="fas fa-map-marker-alt mr-1.5"></i> {{ $kegiatan->lokasi }}
                    </div>
                @endif
                <h1
                ...
                <div class="flex flex-wrap items-center gap-6 text-slate-500">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-sm">
                            <p class="font-bold text-slate-900 leading-none mb-1">{{ $kegiatan->user->name }}</p>
                    ...
                    <div class="flex items-center gap-2 text-sm">
                        ...
                        <time datetime="{{ $kegiatan->tanggal_kegiatan->toIso8601String() }}">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    @if ($kegiatan->gambar)
                        <div class="relative mb-12 group">
                            ...
                            <div
                                ...
                                <a href="{{ asset('storage/' . $kegiatan->gambar) }}" target="_blank"
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex gap-2">
                                <a href="https://wa.me/?text={{ urlencode($kegiatan->judul . ' - ' . route('kegiatan.show', $kegiatan->slug)) }}"
                                    target="_blank"
                                ...
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('kegiatan.show', $kegiatan->slug)) }}"
                                    target="_blank"
                                ...
                                <button
                                    onclick="navigator.clipboard.writeText('{{ route('kegiatan.show', $kegiatan->slug) }}')"
                ...
                <aside class="lg:col-span-4 space-y-12">
                    ...
                    <div class="sticky top-28">
                        <div
                            class="bg-gradient-to-br from-[#1a4fa0] to-indigo-700 rounded-[2rem] p-8 text-white shadow-2xl shadow-blue-900/20 relative overflow-hidden group">
                            <div
                            ...
                            <div class="relative z-10">
                                <h3 class="text-xl font-bold mb-4 leading-tight text-white">Ingin mengikuti agenda Lab
                                    selanjutnya?</h3>
                        ...
                        @if ($recentKegiatans->count() > 0)
                            <div class="mt-8">
                                ...
                                <div class="space-y-6">
                                    @foreach ($recentKegiatans as $recent)
                                        <a href="{{ route('kegiatan.show', $recent->slug) }}"
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <h4
                                                    class="text-sm font-bold text-slate-900 line-clamp-2 leading-snug group-hover:text-[#1a4fa0] transition-colors">
                                                    {{ $recent->judul }}
                                                </h4>
                                                <p
                                                    ...
                                                    {{ $recent->tanggal_kegiatan->translatedFormat('d M Y') }}
                                                </p>
                                            </div>
                                        </a>
                                    @endforeach
                        ...
                        <div class="mt-12 p-6 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm">
                            <h4 class="text-sm font-bold text-slate-900 mb-2">Pusat Informasi</h4>
                            <p class="text-[13px] text-slate-500 mb-4">Ingin berkolaborasi atau bertanya seputar kegiatan
                                kami?</p>
