...
@section('title', '500 - Terjadi Masalah Sistem')
...
@section('content')
    <div class="max-w-screen-xl mx-auto px-6 py-24 md:py-32 flex flex-col items-center justify-center min-h-[70vh]">
        ...
        <div class="mb-12">
            <div class="relative">
                <div class="absolute inset-0 bg-red-100 rounded-[2.5rem] blur-2xl opacity-50 scale-150"></div>
                <div class="w-24 h-24 md:w-32 md:h-32 bg-white border border-red-50 rounded-[2.5rem] flex items-center justify-center shadow-2xl shadow-red-900/5 relative">
                    <i class="fas fa-server text-4xl md:text-5xl text-red-500 animate-pulse"></i>
                </div>
            </div>
        </div>
        ...
        <div class="text-center space-y-6 max-w-2xl">
            <div class="space-y-4">
                <h1 class="text-6xl md:text-8xl font-black text-red-50 leading-none select-none">500</h1>
                <h2 class="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
                    Masalah <span class="text-red-500">Internal Sistem</span>
                </h2>
            </div>
            
            <p class="text-lg text-slate-500 font-medium leading-relaxed max-w-lg mx-auto">
                Maaf, terjadi kesalahan teknis pada layanan kami. Tim asisten sedang berusaha menormalkan kembali sistem secepat mungkin.
            </p>
        </div>
