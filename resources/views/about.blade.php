            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="flex flex-col gap-6 relative z-10">
                    ...
                    <h1
                        ...
                        Mengenal <br>
                        <span class="text-[#1a4fa0]">Lab. Rekayasa Perangkat Lunak</span>
                    </h1>
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <div class="absolute bottom-6 left-6 text-white">
                            <h3 class="font-bold text-xl">Riset & Inovasi</h3>
                            <p class="text-white/80 text-sm">Membangun Masa Depan Digital Berkelanjutan</p>
                        </div>
                    </div>
                </div>
            </div>
