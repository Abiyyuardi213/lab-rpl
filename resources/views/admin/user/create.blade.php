    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-zinc-500 mt-1">Daftarkan admin atau asisten laboratorium baru.</p>
            </div>
        </div>

        <!-- Form Card -->
        <div class="rounded-xl border border-zinc-200 bg-white text-zinc-950 shadow-sm overflow-hidden">
            <form action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    <label for="password"
                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-zinc-900">Password</label>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-4">
                        <div id="preview-container"
                            class="h-16 w-16 rounded-md border border-dashed border-zinc-300 flex items-center justify-center text-zinc-400 overflow-hidden bg-zinc-50">
