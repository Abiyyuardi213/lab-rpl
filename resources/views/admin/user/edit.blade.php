...
@section('content')
    <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black text-zinc-800 tracking-tight">Edit Pengguna</h1>
                <p class="text-sm font-medium text-zinc-500 mt-1">Perbarui informasi profil pengguna.</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.user.update', $user->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="username" id="username" value="{{ old('username', $user->username) }}"
                            class="w-full rounded-xl border border-zinc-200 bg-zinc-50/50 px-4 py-2.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-zinc-900/5 focus:border-zinc-900 transition-all font-medium"
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-center">
                        <label for="password" class="text-xs font-bold uppercase tracking-widest text-zinc-400">Password
                            Baru</label>
                        <span class="text-[10px] font-medium text-zinc-400 italic">Kosongkan jika tidak ingin diubah</span>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-6">
                        <div id="preview-container"
                            class="w-20 h-20 rounded-2xl border-2 border-zinc-100 flex items-center justify-center text-zinc-300 overflow-hidden bg-zinc-50/50">
