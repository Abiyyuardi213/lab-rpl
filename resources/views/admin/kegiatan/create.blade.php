...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-start justify-between">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-zinc-900">Buat Laporan Kegiatan Baru</h1>
                <p class="text-sm text-zinc-500 mt-1">Publikasikan report kegiatan yang telah dilaksanakan oleh Lab RPL.</p>
            </div>
                    ...
                    <div class="space-y-4">
                        <div class="grid gap-2">
                            ...
                            <input type="date" id="tanggal_kegiatan" name="tanggal_kegiatan"
                                value="{{ old('tanggal_kegiatan', date('Y-m-d')) }}" required
