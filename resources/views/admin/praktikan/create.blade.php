@extends('layouts.admin', ['title' => 'Tambah Praktikan'])
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-zinc-900">Tambah Praktikan</h1>
                    <p class="text-sm text-zinc-500 mt-1">Daftarkan praktikan baru ke dalam sistem.</p>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.praktikan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="email" name="email" id="email" value="{{ old('email') }}"
                                        class="flex h-10 w-full rounded-lg border border-zinc-200 bg-zinc-50/50 px-3 py-1 text-sm shadow-sm transition-all focus:bg-white focus:ring-2 focus:ring-[#001f3f]/10 focus:border-[#001f3f] outline-none"
                                        placeholder="mahasiswa@itats.ac.id" required>
                                    @error('email')
                                        <p class="text-[10px] font-medium text-rose-500 mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="rounded-xl bg-[#001f3f]/5 border border-[#001f3f]/10 p-5">
                            <h4
                                class="text-sm font-bold text-[#001f3f] flex items-center gap-2 mb-2 uppercase tracking-wider">
                                <i class="fas fa-lightbulb"></i>
                                Tips
                            </h4>
                            <p class="text-xs text-zinc-600 leading-relaxed">
                                Pastikan foto praktikan terlihat jelas untuk mempermudah identifikasi saat pelaksanaan
                                praktikum.
                            </p>
                        </div>
                    </div>
