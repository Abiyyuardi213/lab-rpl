@extends('layouts.admin', ['title' => 'Edit Praktikan'])
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-zinc-900">Edit Praktikan</h1>
                    <p class="text-sm text-zinc-500 mt-1">Perbarui informasi praktikan yang sudah terdaftar.</p>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.praktikan.update', $praktikan->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="username" id="username"
                                        value="{{ old('username', $praktikan->username) }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="email" name="email" id="email"
                                        value="{{ old('email', $praktikan->email) }}"
                                        class="flex h-10 w-full rounded-lg border border-zinc-200 bg-zinc-50/50 px-3 py-1 text-sm shadow-sm transition-all focus:bg-white focus:ring-2 focus:ring-[#001f3f]/10 focus:border-[#001f3f] outline-none"
